...
export const ENEMY_DEFS = {
    drone: { hp: 24, xp: 18, width: 3, height: 1, mass: 0.8, cost: 1 },
    brute: { hp: 96, xp: 60, width: 5, height: 5, mass: 3, cost: 5 },
    brute_medium: { hp: 38, xp: 26, width: 3, height: 3, mass: 1.5, cost: 2 },
    shooter: { hp: 42, xp: 28, width: 3, height: 3, mass: 1, cost: 3 },
    worm: { hp: 44, xp: 34, width: 3, height: 1, mass: 1.1, cost: 3 },
    virus: { hp: 46, xp: 38, width: 3, height: 3, mass: 1.2, cost: 4 },
    kamikaze: { hp: 22, xp: 22, width: 3, height: 1, mass: 0.6, cost: 2 },
    shield_projector: { hp: 70, xp: 46, width: 3, height: 3, mass: 2, cost: 5 },
    cell_spore: { hp: 18, xp: 8, width: 1, height: 1, mass: 0.25, cost: 1, ecosystem: true, populationCost: 1 },
    cell_colony: { hp: 20, xp: 10, width: 1, height: 1, mass: 2, cost: 1, ecosystem: true, populationCost: 1 },
    cell_parasite: { hp: 20, xp: 14, width: 1, height: 1, mass: 0.35, cost: 1, ecosystem: true, populationCost: 1 },
    cell_amalgam: { hp: 120, xp: 90, width: 5, height: 3, mass: 4, cost: 7, ecosystem: true, populationCost: 5 },
    boss_snake: { hp: 2500, xp: 1000, width: 48, height: 13, mass: 22, cost: 0 },
    boss_eye: { hp: 3200, xp: 1100, width: 35, height: 23, mass: 18, cost: 0 },
    boss_carrier: { hp: 4500, xp: 1300, width: 40, height: 23, mass: 24, cost: 0 }
};
...
export const COMBAT_CONFIG = {
    ...
    normalPopulationCap: 56,
    ecosystemPopulationCap: 18,
